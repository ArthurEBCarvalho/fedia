    ...
    <div class="panel panel-default table-responsive">
        <table class="table table-bordered templatemo-user-table">
            ...
            <tbody>
                ...
                <tr>
                    <td @if($partida->resultado1 > $partida->resultado2) bgcolor="F0FFF0" @endif @if($partida->resultado1 < $partida->resultado2) bgcolor="FFF0F0" @endif align="center">{!! Html::image(Storage::url('times/'.$partida->time1()->escudo), $partida->time1()->nome, ['class' => 'time_img']) !!}</td>
                    ...
                    <td @if($partida->resultado1 < $partida->resultado2) bgcolor="F0FFF0" @endif @if($partida->resultado1 > $partida->resultado2) bgcolor="FFF0F0" @endif align="center">{!! Html::image(Storage::url('times/'.$partida->time2()->escudo), $partida->time2()->nome, ['class' => 'time_img']) !!}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="panel panel-default table-responsive">
        <table class="table table-bordered templatemo-user-table">
            ...
            <tbody>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['4|1']->time1_id == @$partidas['0|1']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['4|1']->time1_id == @$partidas['0|1']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['0|1']->time1()->escudo), @$partidas['0|1']->time1()->nome, ['class' => 'time_img']) !!}</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['4|1']->time1_id == @$partidas['0|2']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['4|1']->time1_id == @$partidas['0|2']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['0|1']->time2()->escudo), @$partidas['0|1']->time2()->nome, ['class' => 'time_img']) !!}</td>
                    ...
                    <td @if((@$partidas['6|1']->time1_id == @$partidas['4|1']->time1_id) && !is_null(@$partidas['6|1']->time1_id)) bgcolor="#F0FFF0" @else @if((@$partidas['6|1']->time1_id == @$partidas['4|1']->time2_id) && !is_null(@$partidas['6|1']->time1_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">@if(isset($partidas['4|1']) && isset($partidas['4|1']->time1_id)) {!! Html::image(Storage::url('times/'.@$partidas['4|1']->time1()->escudo), @$partidas['4|1']->time1()->nome, ['class' => 'time_img']) !!} @endif</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['4|2']->time1_id == @$partidas['1|1']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['4|2']->time1_id == @$partidas['1|1']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['1|1']->time1()->escudo), @$partidas['1|1']->time1()->nome, ['class' => 'time_img']) !!}</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['4|2']->time1_id == @$partidas['1|2']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['4|2']->time1_id == @$partidas['1|2']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['1|1']->time2()->escudo), @$partidas['1|1']->time2()->nome, ['class' => 'time_img']) !!}</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['5|1']->time1_id == @$partidas['2|1']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['5|1']->time1_id == @$partidas['2|1']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['2|1']->time1()->escudo), @$partidas['2|1']->time1()->nome, ['class' => 'time_img']) !!}</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['5|1']->time1_id == @$partidas['2|2']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['5|1']->time1_id == @$partidas['2|2']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['2|1']->time2()->escudo), @$partidas['2|1']->time2()->nome, ['class' => 'time_img']) !!}</td>
                    ...
                    <td @if((@$partidas['6|2']->time1_id == @$partidas['5|1']->time1_id) && !is_null(@$partidas['6|2']->time1_id)) bgcolor="#F0FFF0" @else @if((@$partidas['6|2']->time1_id == @$partidas['5|1']->time2_id) && !is_null(@$partidas['6|2']->time1_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">@if(isset($partidas['5|1']) && isset($partidas['5|1']->time1_id)) {!! Html::image(Storage::url('times/'.@$partidas['5|1']->time1()->escudo), @$partidas['5|1']->time1()->nome, ['class' => 'time_img']) !!} @endif</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['5|2']->time1_id == @$partidas['3|1']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['5|2']->time1_id == @$partidas['3|1']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['3|1']->time1()->escudo), @$partidas['3|1']->time1()->nome, ['class' => 'time_img']) !!}</td>
                ...
                <tr>
                    <td style="border:0;"></td>
                    <td @if(@$partidas['5|2']->time1_id == @$partidas['3|2']->time1_id) bgcolor="#F0FFF0" @else @if(@$partidas['5|2']->time1_id == @$partidas['3|2']->time2_id) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="70">{!! Html::image(Storage::url('times/'.@$partidas['3|1']->time2()->escudo), @$partidas['3|1']->time2()->nome, ['class' => 'time_img']) !!}</td>
