...
<div class="templatemo-content-widget white-bg">
    <h2 class="margin-bottom-10">Partidas @if($tipo == 'taca') Taça @else {{ucfirst($tipo)}} @endif FEDIA</h2>
    <div class="row">
...
<div class="templatemo-content-widget no-padding">
    <div class="panel panel-default table-responsive">
        <table class="table table-bordered templatemo-user-table">
            <thead>
                <tr>
                    <th colspan="16">@if($tipo == 'copa') Copa @else Taça @endif FEDIA - Temporada {{@$temporada->numero}}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td @if((@$partidas['6|1']->time2_id == @$partidas['5|1']->time1_id) && !is_null(@$partidas['6|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id))) bgcolor="#F0FFF0" @else @if((@$partidas['6|1']->time2_id == @$partidas['5|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="left" width="200">@if(isset($partidas['5|1'])) {{@$partidas['5|1']->time1()->nome}} @endif</td>
                    <td @if((@$partidas['6|1']->time2_id == @$partidas['5|1']->time1_id) && !is_null(@$partidas['6|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id))) bgcolor="#F0FFF0" @else @if((@$partidas['6|1']->time2_id == @$partidas['5|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="60">@if(isset($partidas['5|1'])) {{$partidas['5|1']->resultado1}} @endif</td>
                ...
                <tr>
                    ...
                    <td @if((@$partidas['6|1']->time2_id == @$partidas['5|2']->time1_id) && !is_null(@$partidas['6|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id))) bgcolor="#F0FFF0" @else @if((@$partidas['6|1']->time2_id == @$partidas['5|2']->time2_id) && !is_null(@$partidas['6|1']->time2_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="left" width="200">@if(isset($partidas['5|1'])) {{@$partidas['5|1']->time2()->nome}} @endif</td>
                    <td @if((@$partidas['6|1']->time2_id == @$partidas['5|2']->time1_id) && !is_null(@$partidas['6|1']->time2_id) && !is_null(@$partidas['6|1']->time2_id))) bgcolor="#F0FFF0" @else @if((@$partidas['6|1']->time2_id == @$partidas['5|2']->time2_id) && !is_null(@$partidas['6|1']->time2_id)) bgcolor="FFF0F0" @else bgcolor="F9F9F9" @endif @endif align="center" width="60">@if(isset($partidas['5|1'])) {{$partidas['5|1']->resultado2}} @endif</td>
